export default class AdminAccountUserCtrl {
    constructor(UserService, AdminService, RoleService, $translate) {
    ...
    $.Pages.init(); // eslint-disable-line
        ...
        this.getAdmins(this.searchCriteria);
        this.getRoles();
    }
    getAdmins(searchCriteria) {
        const _onSuccess = (res) => {
            if (res.status === 200) {
                this.adminUsers = res.data.data.admins;
        ...
        this._AdminService.getAdmins(searchCriteria)
...
AdminAccountUserCtrl.$inject = ['UserService', 'AdminService', 'RoleService', '$translate'];
